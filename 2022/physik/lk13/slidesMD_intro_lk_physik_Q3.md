...
1. Beschreiben Sie die Aufstellung als eine Sammlung an Vektoren. Beispiel: könig = (A,0) TODO: Bild Schachsituation
...
3. Zeichnen Sie in einem 2D-Koordinatensystem in einem quadratischen Raumbereich der Seitenlänge 4 an allen ganzzahligen Koordinaten die Kraftwirkung eines homogenen Magnetfeldes ein. Der Betrag der Kraft F_el = 1 N (1cm), die Richtung ist F_el = (1,1)
